...
func TestUser(t *testing.T) {
	...
	t.Log("Given the need to work with User records.")
	{
		...
		t.Logf("\tTest %d:\tWhen handling a single User.", testID)
		{
			...
			traceID := "00000000-0000-0000-0000-00000000000"

			nu := user.NewUser{
				Name:            "Test User",
				Email:           "johndoe@smtweirdfortests.com",
			...
			upd := user.UpdateUser{
				Name:  tests.StringPointer("Doe John"),
				Email: tests.StringPointer("doejohn@smtweirdfortests.com"),
			}
