...
// validate holds the settings and caches for validating reques strcut values.
...
func init() {
	...
	// Instantize the validator for use.
	validate = validator.New()

	// Instantize the english locale for the validator library.
	enLocale := en.New()
	...
	// Registe the english error messages for validation errors.
