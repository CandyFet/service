...
func Respond(ctx context.Context, w http.ResponseWriter, data interface{}, statusCode int) error {
	...
	// If there is nothing to marshal the set status code and return.
	...
	// Set the conent type and headers once we know marshaling has succeeded.
...
func RespondError(ctx context.Context, w http.ResponseWriter, err error) error {
	...
	// If not, the handler sen any arbitrary error value so use 500.
	er := ErrorResponse{
